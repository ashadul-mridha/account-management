	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				...
				<h4 class="page-header-title">Edit Member</h4>
			...
			<div id="add_div" class="widget-body">
				<form id="add_form" action="{{ route('update.member') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					{{ csrf_field() }}
					...
					<div class="form-group row d-flex align-items-center mb-5">
						<label class="col-lg-3 form-control-label">Member Picture</label>
						<div class="col-lg-9">
							<img style="height: 250px; width:250px;" class="card-img-top" src="{{asset('public/Image/Member/Photo')}}/{{$row->photo}}" alt="Member Picture">
					...
					<div class="form-group row d-flex align-items-center mb-5">
						<div class="col-lg-12">
							<div class="card" style="width: 18rem;">
                                ...
                                <img style="height: 250px; width:250px;" class="card-img-top" src="{{asset('public/Image/Member/Nid/Front')}}/{{$row->nid_photo_front}}" alt="NID Front Picture">
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-12">
							<div class="card" style="width: 18rem;">
                                ...
                                <img style="height: 250px; width:250px;" class="card-img-top" src="{{asset('public/Image/Member/Nid/Back')}}/{{$row->nid_photo_back}}" alt="NID Back Picture">
					...
					{{-- <div class="form-group row">
						<div class="form-group col-md-6">
							...
							<div class="card" style="width: 18rem;">
                                <img style="height: 250px; width:250px;" class="card-img-top" src="/storage/Image/Nid/Front/{{$member->nid_photo_front}}" alt="NID Front Picture">
                            </div>
						</div> --}}
					...
					{{-- <div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input  name="nid_photo_front" value="{{$row->nid_photo_front}}"  type="file" class="form-control">
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input  name="nid_photo_back" type="file" value="{{$row->nid_photo_back}}"class="form-control">
