...
<head>
      ...
      <div class="row flex-row h-100 bg-white">
       ...
       <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 col-12 no-padding">
        ...
        <ul class="login-nav nav nav-tabs mt-5 justify-content-center" role="tablist" id="animate-tab">
         ...
         <li style="display: none;" ><a data-toggle="tab" href="#signup" role="tab" id="signup-tab" data-easein="zoomInRight">Sign Up</a></li>
       </ul>
     </div>
   </div>
 </div>
 ...
 <div class="sign-btn text-center">
  <button class="btn btn-lg btn-gradient-03" type="submit">
   Sign In
 </button>
</form>
...
<div style="display: none;" class="sign-btn text-center">
