	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				...
				<h4 class="page-header-title">Edit Product</h4>
			...
			<div id="add_div" class="widget-body">
				<form id="add_form" action="{{ route('update.product')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					{{ csrf_field() }}
						...
						<div class="col-lg-9">
                            <select name="supplier_name" id="supplier_name" class="form-control">
                                @foreach ($all_supplier as $row)
                                    <option value="{{$row->id}}" {{$product->supplier_name == $row->id ? 'selected' : ''}}>{{$row->supplier_name}}</option>
                                @endforeach
                            </select>
							@error('member_name')
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="product_name" value="{{ $product->product_name }}" placeholder="Enter Your Product Name" type="text" class="form-control">
							@error('product_name')
                            	   <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="product_price" value="{{ $product->product_price}}" placeholder="Enter Your Product Price" type="text" class="form-control">
							@error('product_price')
                            	   <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="product_quantity" value="{{ $product->product_quantity }}" placeholder="Enter Your Product Quantity" type="text" class="form-control">
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input name="car_rent" value="{{ $product->car_rent }}"" placeholder="Enter Car Rent Amount" type="text" class="form-control">
							@error('car_rent')
                        	    <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input name="other_cost" value="{{ $product->other_cost }}" placeholder="Other Cost" type="text" class="form-control">
							@error('other_cost')
                            	   <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="col-lg-9">
							<input name="notes" value="{{ $product->notes }}" placeholder="Your Notes" type="text" class="form-control">
                            @error('notes')
                                   <strong class="text-danger">{{ $message }} </strong>
                            @enderror
                        </div>
