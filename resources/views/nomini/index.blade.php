	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				<h4 class="page-header-title">Nomini List</h4>
				<div class="widget-options">
					<a  href="{{route('create.nomini')}}" type="button" class="btn btn-primary btn-square mr-1 mb-2">Add Nomini</a>
				</div>
			</div>
