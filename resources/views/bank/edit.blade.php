	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				...
				<h4 class="page-header-title">EDit Bank Account</h4>
			...
			<div id="add_div" class="widget-body">
				<form id="add_form" action="{{ route('update.bank') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					{{ csrf_field() }}
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="name" value="{{$bank_account->name}}" placeholder="Enter Your Bank Name" type="text" class="form-control">
							@error('name')
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="account_name" value="{{$bank_account->account_name}}" placeholder="Enter Your Account Name" type="text" class="form-control">
							@error('account_name')
                        	    <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input required name="account_number" value="{{$bank_account->account_number}}" placeholder="Enter Your Account Number" type="text" class="form-control">
                    ...
                    <div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
                            <select name="account_type" id="account_type" class="form-control" >
                                <option value="current"{{ $bank_account->account_type == 'current' ? 'selected' : '' }}>Current</option>
                                <option value="saving" {{ $bank_account->account_type == 'saving' ? 'selected' : '' }}>Saving</option>
                                <option value="personal" {{ $bank_account->account_type == 'personal' ? 'selected' : '' }}>Personal</option>
                                <option value="Loan" {{ $bank_account->account_type == 'Loan' ? 'selected' : '' }}>Loan</option>
                            </select>
							@error('account_type')
                            	   <strong class="text-danger">{{ $message }} </strong>
                            @enderror
					...
					<div class="form-group row d-flex align-items-center mb-5">
						...
						<div class="col-lg-9">
							<input  name="address" value="{{$bank_account->address}}" placeholder="Enter Your Address" type="text" class="form-control">
							@error('address')
                        	    <strong class="text-danger">{{ $message }} </strong>
                            @enderror
						</div>
