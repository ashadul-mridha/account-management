...
@section('pageTitle', 'Add PhoneBook')
	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				...
				<h4 class="page-header-title">Add PhoneBook</h4>
			...
			<div id="add_div" class="widget-body">
				<form id="add_form" action="{{route('store.phonebook')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					{{ csrf_field() }}
