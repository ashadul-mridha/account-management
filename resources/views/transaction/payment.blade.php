		...
		<div class="widget has-shadow">
			<div class="widget-header bordered no-actions d-flex align-items-center">
				...
				<div class="widget-options">
					<a  href="{{ route('allpayment.transaction')}}" type="button" class="btn btn-primary btn-square mr-1 mb-2">All Payment</a>
				</div>
				<div style="display: none;" class="widget-options">
                    ...
                    <div id="add_div" class="widget-body">
                        <form id="add_form" action="{{route('paymentstore.transaction')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            {{ csrf_field() }}
